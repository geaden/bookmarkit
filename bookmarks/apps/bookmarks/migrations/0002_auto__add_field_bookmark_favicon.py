...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bookmark.favicon'
        db.add_column(u'bookmarks_bookmark', 'favicon',
                      self.gf('django.db.models.fields.URLField')(default='http://www.feederpro.nl/images/defaultFavicon.gif', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bookmark.favicon'
        db.delete_column(u'bookmarks_bookmark', 'favicon')
    ...
    models = {
        ...
        u'bookmarks.bookmark': {
            ...
            'favicon': ('django.db.models.fields.URLField', [], {'default': "'http://www.feederpro.nl/images/defaultFavicon.gif'", 'max_length': '200'}),
